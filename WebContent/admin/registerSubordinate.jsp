		                        ...
		                        <div class="container">
		                            ...
		                            <form method="post" action="AdminController" data-parsley-validate>
			                        	<div class="field">
			                                ...
			                                <div class="control">
			                                    <input class="input is-medium is-rounded" type="text" name="admName" value="" placeholder="Masukkan Nama" 
			                            ...
			                            <div class="field">
			                                ...
			                                <div class="control">
			                                    <input class="input is-medium is-rounded" type="email" name="admEmail" value="" placeholder="Masukkan E-Mel" 
			                            ...
			                            <div class="field">
			                                ...
			                                <div class="control">
			                                    <input class="input is-medium is-rounded" type="text" name="admPhone" value="" placeholder="Masukkan Telefon Bimbit" 
			                                    data-parsley-required data-parsley-required-message="Ruang ini wajib diisi" 
			                            ...
			                            <div class="field">
			                        		...
			                        		<div class="control">
			                        			<div class="select is-medium is-rounded is-fullwidth">
				                                    <select name="svID" data-parsley-required data-parsley-required-message="Ruang ini wajib dipilih">
