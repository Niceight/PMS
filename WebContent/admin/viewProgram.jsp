		                        ...
		                        <div class="container">
		                            ...
		                            <p class="content is-medium"><strong><c:out value="${statusProgram.status}" /></strong></p>
		                           	...
		                           	<div class="buttons is-right">
									 	...
									 	href="ProgramAdminController?action=updateProgram&progID=<c:out value="${program.progID}"/>">Pinda Program</a>
									 	...
									 	href="ProgramAdminController?action=updateARProgram&progID=<c:out value="${program.progID}"/>">Pinda Program</a>
										<a onclick="return confirm('Anda pasti batal program ini? 😮');" class="button is-medium is-danger is-rounded" 
										href="ProgramAdminController?action=deleteProgram&progID=<c:out value="${program.progID}"/>&orgID=<c:out value="<%=id%>"/> ">
										Batal Program</a>
		                           	</div>
		                        </div>
		                    </div>
